...
watch(() => brandStoreStore.filters, (newFilters) => {
...
onMounted(() => {
  ...
  // 从 store 恢复筛选条件
  searchKeyword.value = brandStoreStore.filters.searchKeyword
  filterCity.value = brandStoreStore.filters.filterCity
  filterDistrict.value = brandStoreStore.filters.filterDistrict
  filterBrand.value = brandStoreStore.filters.filterBrand
  filterCategory.value = brandStoreStore.filters.filterCategory
})
</script>
